...
To answer the research question this section will firstly explore the data descriptively. - UK stats (GDPpc developments, top partners 2010 vs 2020) - EU vs. non-EU broadly - seleted partners

Next, it will prsent some statistical models to better understand the data - regression analyses
...
As part of this project we have looked at ... The analysis have shown ... The limitations of the analysis are ... (pandemic effect on world economy, the analysis don't cover development after actual brexit, and a word on causality)
